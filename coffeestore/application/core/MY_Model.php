...
class MY_Model extends CI_Model {
    ...
    protected function get_list_set_input($input = array())
    {
        ...
        // Add điều kiện cho câu truy vấn truyền qua biến $input['where'] 
        ...
        // Add sắp xếp dữ liệu thông qua biến $input['order'] 
        ...
        // Add điều kiện limit cho câu truy vấn thông qua biến $input['limit'] 
