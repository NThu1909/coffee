...
<div class="row">
	...
	<form action="" method="post" >
		<div class="panel panel-info">
			...
			<div class="col-md-8">Management Product</div>
			<div class="col-md-4 text-right"><a href="<?php echo admin_url('product/add'); ?>" class='btn btn-info'><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Add Product</a></div>
			</div>
								...
								<?php foreach ($product as $value) { ?>
									<tr>
										...
										<td class="list_td aligncenter">
								            ...
								            <a id="<?php echo $value->id; ?>" title="Delete" class="remove" onclick=" return confirm('Are you sure you want to delete ?')"> <span class="glyphicon glyphicon-remove" ></span> </a>
									    </td>    
					                </tr>
								<?php } ?>
