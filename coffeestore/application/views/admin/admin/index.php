								...
								<tr>
									...
									<td class="list_td aligncenter">
							            ...
							            <?php if ($value->level!='0') { ?>
							            	<a href="../admin/admin/del/<?php echo $value->id; ?>" title="Delete"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Are you sure you want to delete ?')"></span> </a>
							            <?php } ?>
