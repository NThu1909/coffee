		  ...
		  <div class="panel-body">
	  		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="text-center">
		            ...
		            <img  src="<?php echo base_url(); ?>upload/product/<?php echo $product->image_link; ?>" alt="" style="width:380px;height: 350px">
			        </a>
		  	...
		  	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		  		...
		  		<?php 
		  			if ($product->discount > 0) {
		  				...
		  				?><p>Old price: <strong><del><?php echo number_format($product->price) ?> USD</del></strong></p>
		  				<p>Promotional price: <span style="font-weight: bold;color: green"><?php echo number_format($price_new); ?> USD</span></p>
		  			<?php }else{ ?>
		  				<p>Price: <span style="font-weight: bold;color: green"><?php echo number_format($product->price); ?> USD</span></p> <?php
		  			}
		  		?>
		  		<p>Number of views: <?php echo $product->view; ?></p>
		  		<p> Rate &nbsp;
		  		<?php $raty_tb = $product->rate_total/$product->rate_count; ?>
                       ...
                       | Total rate: <b  class='rate_count'><?php echo $product->rate_count; ?></b>
				</p>
		  	...
		  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
		  		...
		  		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		  			<img src="<?php echo base_url(); ?>upload/icon/services.png" alt="">
		  			<p style="color:red">Exchange product</p>
		  		</div>
		  	</div>
		  </div>
		</div>
