<div class="row" style="margin-top: 8px;height: 110px">
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 clearpadding">
				<a href="<?php echo base_url(); ?>"><img style="max-height: 180px;width: 100%" src="<?php echo base_url(); ?>upload/logo6.jpg" alt="" class="img-responsive"></a>
			</div>
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 clearpadding">
				<a href="#"><img style="max-height: 180px;width: 100%" src="<?php echo base_url(); ?>upload/logo10.jpg" alt="" class="img-responsive"></a>
			</div>
		</div>
		<div class="row">
			  ...
			  <div class="container-fluid re-container-fluid">
			    ...
			    <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        ...
			        <li><a href="<?php echo base_url('ban-chay'); ?>">Bestseller</a></li>
			        <li class="dropdown">
			        ...
			        <li><a href="<?php echo base_url('khuyen-mai'); ?>">Promotions</a></li>
			       </ul>
			      <ul class="nav navbar-nav navbar-right">
			        <?php $this->load->view('site/cart/cart_sh'); ?>
			        
			        <?php if (!isset($user)) { ?>
			        	<li><a href="<?php echo base_url('dang-nhap'); ?>">Log in</a></li>
			        <?php }else{ ?>
						<li class="dropdown">
