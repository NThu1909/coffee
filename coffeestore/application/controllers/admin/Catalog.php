...
class Catalog extends MY_Controller {
	...
	public function add()
	{
		...
		if ($this->input->post()) {
			$this->form_validation->set_rules('name','Name category','required');
			if ($this->form_validation->run()) {
				...
				if ($this->catalog_model->create($data)) {
					$this->session->set_flashdata('message_success', 'Add successful category');
				}else{
					$this->session->set_flashdata('message_fail', 'Add failure category');
				}
	...
	public function del()
	{
		...
		if ($this->catalog_model->delete($id)) {
			...
			$this->session->set_flashdata('message_fail', 'Delete failed category');
		}
		redirect(admin_url('catalog'));
	}
}
